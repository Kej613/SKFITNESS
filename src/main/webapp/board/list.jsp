...
<body>
	<jsp:include page="../header.jsp" />
		<div class="container"align="center">
			<br><br><p class=font1>Customer Board</p><hr><br>
		</div>
	</div>
	<div class="container">
		<form action="<c:url value="./BoardListAction.do"/>" method="post">
			<div>
				<div class="text-right">
					<span class="badge badge-dark">전체 <%=total_record%>건	</span>
				</div>
			</div>
				...
				<table>
					<tr>
						...
						<td width="100%" align="right">
							<a href="#" onclick="checkForm(); return false;" class="btn btn-outline-dark">글쓰기</a>
						</td>
					</tr>
				</table>
			</div>
