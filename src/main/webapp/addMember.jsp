...
<body>
	<jsp:include page="/header.jsp" />
		<div class="container" >
			<br><br><p class=font1>회원가입</p><hr><br><br>
		</div>
		...
		<form name="newMember" class="form-horizontal"  action="processAddMember.jsp" method="post" onsubmit="return checkForm()">
			...
			<div class="form-group" style="text-align:right;" >
				<div class="col-sm-offset-2 col-sm-10 ">
					<input type="button" class="btn btn-outline-dark " value="등록 " onclick="CheckAddMember()"> 
					<input type="reset" class="btn btn-outline-dark " value="취소 " onclick="reset()" >
				</div>
			</div>
		</form>
	</div>
